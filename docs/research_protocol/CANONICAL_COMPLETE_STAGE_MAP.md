# Canonical Complete Stage Map

TrustCXR uses two non-interchangeable systems: actual repository identifiers and original roadmap stages. Actual identifiers remain authoritative for history and gates; original identifiers remain authoritative for product-capability coverage. No original stage replaces or renames an actual stage.
...
- Actual Stage 5 maps mainly to original Stage 9, with device work incomplete.
- Actual Stage 6 maps mainly to original Stage 4.
- Actual Stage 7B–7E maps mainly to original Stage 5.
- Actual Stage 8A–8E maps mainly to original Stage 6.
- Actual Stage 9A–9C maps to the bounded segmentation-guided portion of original Stage 8.
- Original Stage 7 remains a separate future lesion-localization capability.
