# Original Stage 12 — Severity Analysis

- Original stage identifier: `12`
- Canonical repository mapping: `Unassigned future actual stage`
- Current status: `WAITING_FOR_ANNOTATIONS`
- Objective: Severity Analysis under a research-only, patient-safe contract.
...
- Upstream gate: Original Stage 11 gate.
- Required inputs: Requires valid severity annotations or an approved quantitative definition.
...
- Training plan: UNRESOLVED — REQUIRES ANNOTATION AUDIT.
...
- Long-running command: UNRESOLVED — REQUIRES ANNOTATION AUDIT.
...
- Known limitations: Requires valid severity annotations or an approved quantitative definition.
- Completed components: No severity labels are fabricated.
- Missing components: Requires valid severity annotations or an approved quantitative definition.
- Evidence commit: `UNRESOLVED — REQUIRES ANNOTATION AUDIT`
- Downstream gate: Original Stage 13 reliability gate.
