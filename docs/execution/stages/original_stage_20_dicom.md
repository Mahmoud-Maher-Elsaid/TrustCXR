# Original Stage 20 — DICOM and Orthanc Integration

- Original stage identifier: `20`
- Canonical repository mapping: `Unassigned future actual stage`
- Current status: `WAITING_FOR_LICENSE`
- Objective: DICOM and Orthanc Integration under a research-only, patient-safe contract.
...
- Upstream gate: Original Stage 19 UI gate.
- Required inputs: Requires authorized de-identified DICOM, viewer/archive license and compatibility review.
...
- Known limitations: Requires authorized de-identified DICOM, viewer/archive license and compatibility review.
- Completed components: DICOM governance and interoperability scope is specified.
- Missing components: Requires authorized de-identified DICOM, viewer/archive license and compatibility review.
- Evidence commit: `UNRESOLVED — REQUIRES LICENSE VERIFICATION`
- Downstream gate: Original Stage 21 feedback gate.
