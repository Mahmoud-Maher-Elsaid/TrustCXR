# Original Stage 16 — Anatomical and Textual Verifier

- Original stage identifier: `16`
- Canonical repository mapping: `Unassigned future actual stage`
- Current status: `WAITING_FOR_UPSTREAM_GATE`
- Objective: Anatomical and Textual Verifier under a research-only, patient-safe contract.
...
- Upstream gate: Original Stage 15 reporting gate.
- Required inputs: Requires structured evidence and grounded report outputs plus synthetic/approved evaluation cases.
...
- Known limitations: Requires structured evidence and grounded report outputs plus synthetic/approved evaluation cases.
- Completed components: Contradiction taxonomy is specified.
- Missing components: Requires structured evidence and grounded report outputs plus synthetic/approved evaluation cases.
- Evidence commit: `UNRESOLVED — REQUIRES UPSTREAM RESULT`
- Downstream gate: Original Stage 17 decision-policy gate.
