...
$Config = Join-Path $ProjectRoot "configs\interoperability\stage23b_dicom_interoperability_contract.json"
...
& $Python -u -m scripts.interoperability.run_stage23b_dicom_interoperability_contract `
