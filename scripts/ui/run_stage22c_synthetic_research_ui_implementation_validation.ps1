...
$Config = Join-Path $ProjectRoot "configs\ui\stage22c_synthetic_research_ui_implementation_validation.json"
...
& $Python -u -m scripts.ui.run_stage22c_synthetic_research_ui_implementation_validation `
