...
$Config = Join-Path $ProjectRoot "configs\ui\stage22a_research_ui_medical_viewer_data_readiness.json"
...
& $Python -u -m scripts.ui.run_stage22a_research_ui_medical_viewer_data_readiness `
