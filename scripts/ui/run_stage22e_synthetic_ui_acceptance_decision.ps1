...
$Config = Join-Path $ProjectRoot "configs\ui\stage22e_synthetic_ui_acceptance_decision.json"
...
& $Python -u -m scripts.ui.run_stage22e_synthetic_ui_acceptance_decision `
