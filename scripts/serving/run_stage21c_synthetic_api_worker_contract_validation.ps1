...
$Config = Join-Path $ProjectRoot "configs\serving\stage21c_synthetic_api_worker_contract_validation.json"
...
& $Python -u -m scripts.serving.run_stage21c_synthetic_api_worker_contract_validation `
