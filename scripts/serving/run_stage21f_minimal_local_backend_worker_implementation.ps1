...
$Config = Join-Path $ProjectRoot "configs\serving\stage21f_minimal_local_backend_worker_implementation.json"
...
& $Python -u -m scripts.serving.run_stage21f_minimal_local_backend_worker_implementation `
